...
bool SlowSocket::init(addrinfo* addr, const char* host, const bool isSSL, int& maxfd,
...
bool SlowSocket::connect_ssl(addrinfo* addr, const char* sni) {
  ...
  // SSL_set_tlsext_host_name(ssl_, sni);
