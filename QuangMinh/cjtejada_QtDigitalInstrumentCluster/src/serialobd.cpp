...
void SerialOBD::obdRPM(int value) {
    // Dummy implementation
    std::cout << "obdRPM: " << value << std::endl;
}

void SerialOBD::obdCoolantTemp(int value) {
    std::cout << "obdCoolantTemp: " << value << std::endl;
}

void SerialOBD::obdFuelStatus(int value) {
    std::cout << "obdFuelStatus: " << value << std::endl;
}

void SerialOBD::obdMPH(int value) {
    std::cout << "obdMPH: " << value << std::endl;
}

void SerialOBD::obdTroubleCode(QByteArray code) {
    std::cout << "obdTroubleCode: " << code.data << std::endl;
}
