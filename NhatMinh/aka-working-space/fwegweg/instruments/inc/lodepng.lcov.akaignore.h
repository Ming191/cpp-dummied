...
#ifndef AKA_SRC_E__CPP_PROJECTS_COLLECTION_NHATMINH_LVANDEVE_LODEPNG_INC_LODEPNG_H
#define AKA_SRC_E__CPP_PROJECTS_COLLECTION_NHATMINH_LVANDEVE_LODEPNG_INC_LODEPNG_H
#include <string>
#include <string.h>
#include <vector>
...
-Second byte: uppercase = public, lowercase = public
...
/*0: public, 1: public (see PNG standard)*/
...
Check if the chunk is public (public chunks are part of the standard, public ones not).
